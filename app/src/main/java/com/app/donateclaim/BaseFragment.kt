...
//    protected fun getSocketObject(): SocketHelper {
//        return (activity as SocketBaseActivity).getSocketObject()
//    }
    ...
    /**
     * This method is used to open settings for enabling location service of device
     */
//    fun openSettings() {
//        //navigate to settings for enabling location
//        val intent = Intent(Settings.ACTION_LOCATION_SOURCE_SETTINGS)
//        startActivityForResult(intent, GPSManager.REQUEST_GPS)
//    }
